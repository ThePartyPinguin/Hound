...
CACHED_OBJECT_DEFAULT_INIT_FUNC_IMPL(mesh, mesh_cache_module)
...
CACHED_OBJECT_DEFAULT_INIT_FUNC_IMPL_NAMED_P1(mesh, mesh_cache_module, from_absolute_path, const char*, absolute_path)
CACHED_OBJECT_DEFAULT_INIT_FUNC_IMPL_NAMED_P1(mesh, mesh_cache_module, from_asset_path, const char*, absolute_path)
